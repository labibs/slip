...
<div class="profile-right">
	<h4 class="heading"><li><a href="https://jne-cilacap.com/slip/public/potongant" > <span>Detail Potongan</span></a></li> </h4>
		@if(session('sukses'))
...
<table class="table  table-bordered">
  ...
  <tr>
    <td><center><a href="./{{$rt1->id}}/deletepengeluaran" class="btn btn-danger btn-sm" onclick="return confirm('Yakin mau di hapus?')">Hapus</a>
    </center></td>
    <td>{{$rt1->pengurangan}}</td>
    <td><center>{{$rt1->pivot->periode}}</center></td>
    <td align="right"><a href="#" class="nominal" data-name="nominal" data-type="text" data-pk="1" data-url="/post" data-title="Masukan Nominal">{{formatRupiah($rt1->pivot->nominal)}}</a></td>
 </tr>
    @endforeach
 <tr>
...
<form action="./t_potongan" method="POST">
  {{csrf_field()}}

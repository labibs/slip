...
<div class="profile-main">
	...
	<h4 class="heading"><b><center>Juli 2022</center></b></h4>
...
<div class="profile-right">
	<h4 class="heading"><b><center>DETAIL GAJI</center></b></h4>
  	<table class="table  ">
		...
		<tbody>
				...
				@endforeach
			<tr><td colspan="2"><center>Untuk Uang makan dan BBM akan di update dan di transfer pada tanggal 5 di bulan Agustus</center></td></tr>
				<tr>
	...
	<tbody>
		...
		<tr>
		 ...
		 @endforeach
		 <tr><td colspan="2">Catatan: {{$karyawan->catatan7}}</td></tr>
		 <tr>
		...
		<table class="table table-bordered">
 			<thead>
				<tr>
 					<td><center><b>TF 25 Juli</b></center></td>
 					<td><center><b>{{formatRupiah($jumlah-($jumlah1+$umakan+$bbm))}}</b></center></td>
 				</tr>
				<tr>
 					<td><center><b>TF 5 Agustus</b></center></td>
...
<center>	<a href="./exportpdfjul" class="btn btn-primary">Export PDF</a> </center>
<!-- END AWARDS -->
<!-- TABBED CONTENT -->
<!-- END TABBED CONTENT -->
</div>

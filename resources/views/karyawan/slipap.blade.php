...
<div class="profile-main">
	...
	<h4 class="heading"><b><center>April 2022</center></b></h4>
...
<div class="profile-right">
	<h4 class="heading"><b><center>DETAIL GAJI</center></b></h4>
  	<table class="table  ">
		...
		<tbody>
				...
				@endforeach
			<tr><td colspan="2"><center>Untuk Uang makan dan BBM akan di update dan di transfer pada tanggal 9 di bulan Mei</center></td></tr>
				<tr>
	...
	<tbody>
		...
		<tr>
		 ...
		 @endforeach
		 <tr><td colspan="2">Catatan: {{$karyawan->catatan4}}</td></tr>
		 <tr>
		...
		<table class="table table-bordered">
 			<thead>
				<tr>
 					<td><center><b>TF 25 Maret</b></center></td>
 					<td><center><b>{{formatRupiah($jumlah-($jumlah1+$umakan+$bbm))}}</b></center></td>
 				</tr>
				<tr>
 					<td><center><b>TF 9 Mei</b></center></td>
...
<center>	<a href="./exportpdfap" class="btn btn-primary">Export PDF</a> </center>
<!-- END AWARDS -->
<!-- TABBED CONTENT -->
<!-- END TABBED CONTENT -->
</div>

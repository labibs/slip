...
<table class="table-responsive" width="525" border="1" rules="all">
	...
	<table width="700 px" border="1" cellpadding="1" rules="rows">
	   ...
	   <tr>
		 ...
		 <td colspan="4" bgcolor="#008000" width="250 px" ><center><b>GAJI BERSIH</b></center></td>
	   </tr>
	   <tr>
	     <td>Nama Bank</td>
		 <td>:</td>
		 <td>Mandiri</td>
		   <td colspan="4" rowspan="3" bgcolor="#F0F8FF"><center><b><font size="5">{{formatRupiah($jumlah-$jumlah1)}}</font></b></center></td>
	   </tr>
	   <tr>

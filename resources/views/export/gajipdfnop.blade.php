...
<table rules="all"  border="0" cellpadding="0" width="600 px" >
    <tbody>
	   ...
	   <tr>
		   <td colspan="2" width="500px"><center><b><font size="3">NOVEMBER 2022</font></b></center></td>
	   </tr>
	   <tr>
...
<table align="right" border="1" class="table-responsive"   rules="all">
	...
	<tbody>
		...
		@endforeach
		<tr>
			<td colspan="2">Catatan : {{$karyawan->catatan11}}</td>
		</tr>
		<tr>

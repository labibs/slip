...
<div class="profile-main">
	...
	<h4 class="heading"><b><center>Januari 2023</center></b></h4>
...
<div class="profile-right">
	<h4 class="heading"><b><center>DETAIL GAJI</center></b></h4>
  	<table class="table  ">
		...
		<tbody>
				...
				@endforeach
			<tr><td colspan="2"><center>Untuk Uang makan dan BBM akan di transfer pada tanggal 3 di bulan Februari</center></td></tr>
				<tr>
	...
	<tbody>
		...
		<tr>
		 ...
		 @endforeach
		 <tr><td colspan="2">Catatan: {{$karyawan->catatan1}}</td></tr>
		 <tr>
		...
		<table class="table table-bordered">
 			<thead>
				<tr>
 					<td><center><b>TF 24 Januari 2023</b></center></td>
 					<td><center><b>{{formatRupiah($jumlah-($jumlah1+$umakan+$bbm))}}</b></center></td>
 				</tr>
				<tr>
 					<td><center><b>TF 3 Februari 2023</b></center></td>
...
<center>	<a href="./exportpdfjan" class="btn btn-primary">Export PDF</a> </center>
<!-- END AWARDS -->
<!-- TABBED CONTENT -->
<!-- END TABBED CONTENT -->
</div>

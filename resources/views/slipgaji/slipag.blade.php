...
<div class="profile-main">
	...
	<h4 class="heading"><b><center>Agustus 2022</center></b></h4>
...
<div class="profile-right">
	<h4 class="heading"><b><center>DETAIL GAJI</center></b></h4>
  	<table class="table  ">
		...
		<tbody>
				...
				@endforeach
			<tr><td colspan="2"><center>Untuk Uang makan dan BBM akan di transfer pada tanggal 5 di bulan September</center></td></tr>
				<tr>
	...
	<tbody>
		...
		<table class="table table-bordered">
 			<thead>
				<tr>
 					<td><center><b>TF 25 Agusuts</b></center></td>
 					<td><center><b>{{formatRupiah($jumlah-($jumlah1+$umakan+$bbm))}}</b></center></td>
 				</tr>
				<tr>
 					<td><center><b>TF 5 September</b></center></td>
...
<center>	<a href="./exportpdfag" class="btn btn-primary">Export PDF</a> </center>
<!-- END AWARDS -->
<!-- TABBED CONTENT -->
<!-- END TABBED CONTENT -->
</div>

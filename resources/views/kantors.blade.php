...
<div class="panel-heading"><h1>Data Kantor </h1>
...
<center>
<button type="button" data-toggle="modal" data-target="#exampleModal"  class="btn btn-success">Tambah Data Kantor</button>
...
<input name="alamat" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Masukan Nama Jabatan">
</div>
